...
def ray_job_monitor(api_base_url: str = "http://backend-debug:8000"):
    """
    Ray Job监控装饰器 - 简化版本
    ...
    def decorator(func: Callable) -> Callable:
        ...
        def wrapper(*args, **kwargs):
            ...
            try:
                ...
                print(f"Job {job_id} completed successfully in {execution_time:.2f} seconds")
                return result
...
def update_job_status(
    ...
    try:
        ...
        response = requests.post(
            f"{api_base_url}/api/v1/ray/update-status",
            json=update_data,
            timeout=10
        )
